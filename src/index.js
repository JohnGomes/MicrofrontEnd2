...
app.get('/', async (req, res) => {
  ...
  const html = `
    ...
    <body>
      ${header.html}
      ${content.html}
      <script src="http://127.0.0.1:3031/client.js"></script>
      <script src="http://127.0.0.1:3030/client.js"></script>
    </body>
    </html>
  `
...
app.listen(8080, '127.0.0.1',() => console.log('Aggregator Running'))